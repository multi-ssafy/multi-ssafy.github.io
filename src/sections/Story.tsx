...
const STORIES: Story[] = [
  ...
  },
  {
    ...
    company: "SK하이닉스",
    story:
      "기계공학도에서 개발자로 전향한 제게 SSAFY는 유일한 스펙이었습니다. 인턴십이나 대외 공모전 경험은 전무했지만, 오직 SSAFY 프로젝트 수상 이력만으로 면접에서 저의 실력을 증명해냈습니다. 뿐만 아니라 교육과 취업준비를 병행하기 벅찬 와중에도, 취업지원센터의 밀착 컨설팅과 정기적인 채용 소식 공유 덕분에 취업 준비 시간을 효율적으로 관리할 수 있었습니다. 현재는 SSAFY의 체계적인 지원을 발판 삼아, SK하이닉스에서 반도체 생산에 기여하는 개발자로 활약 중입니다.",
    delay: ".30s",
  },
];
